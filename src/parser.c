...
enum {
  ...
  sym_function_identifier = 67,
  sym_function_call = 68,
  aux_sym_translation_unit_repeat1 = 69,
  aux_sym_string_literal_repeat1 = 70,
  aux_sym_condition_repeat1 = 71,
  aux_sym_event_declaration_repeat1 = 72,
};
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_event_region_identifier] = STATE(64),
    [sym_event_region_declaration] = STATE(3),
    [sym_event_identifier] = STATE(63),
    [sym_event_declaration] = STATE(3),
    [sym_function_identifier] = STATE(62),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [33] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_translation_unit_repeat1, 2), SHIFT_REPEAT(33),
  ...
  [42] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_translation_unit_repeat1, 2), SHIFT_REPEAT(25),
  [45] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_translation_unit_repeat1, 2), SHIFT_REPEAT(60),
  [48] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_translation_unit_repeat1, 2), SHIFT_REPEAT(73),
  [51] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_translation_unit_repeat1, 2), SHIFT_REPEAT(71),
  [54] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_translation_unit_repeat1, 2), SHIFT_REPEAT(27),
  ...
  [77] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_event_declaration, 6),
  [79] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition, 5),
  [81] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_call, 4),
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition, 6),
  [85] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_call, 5),
  [87] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition, 7),
  [89] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_event_declaration, 7),
  [91] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_event_declaration, 5),
  [93] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_event_region_declaration, 9),
  ...
  [111] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_literal_repeat1, 2), SHIFT_REPEAT(28),
  [114] = {.entry = {.count = 1, .reusable = true}}, SHIFT(50),
  [116] = {.entry = {.count = 1, .reusable = true}}, SHIFT(14),
  [118] = {.entry = {.count = 1, .reusable = true}}, SHIFT(22),
  [120] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_event_declaration_repeat1, 2),
  [122] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_event_declaration_repeat1, 2), SHIFT_REPEAT(44),
  ...
  [139] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_condition_repeat1, 2),
  [141] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_condition_repeat1, 2), SHIFT_REPEAT(22),
  [144] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [146] = {.entry = {.count = 1, .reusable = true}}, SHIFT(16),
  [148] = {.entry = {.count = 1, .reusable = true}}, SHIFT(48),
  [150] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_getter, 1),
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_getter, 4),
  [154] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__inequality_expression, 2),
  [156] = {.entry = {.count = 1, .reusable = true}}, SHIFT(51),
  [158] = {.entry = {.count = 1, .reusable = true}}, SHIFT(67),
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_identifier, 2),
  [162] = {.entry = {.count = 1, .reusable = true}}, SHIFT(56),
  [164] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__inequality_expression, 3),
  ...
  [178] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__equality_expression, 2),
  [180] = {.entry = {.count = 1, .reusable = true}}, SHIFT(42),
  [182] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_event_region_identifier, 1),
  ...
  [204] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_identifier, 1),
  [206] = {.entry = {.count = 1, .reusable = true}}, SHIFT(19),
  [208] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_event_identifier, 1),
};
