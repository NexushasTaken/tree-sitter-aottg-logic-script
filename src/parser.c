...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [66] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_translation_unit, 1),
  [68] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statement, 1),
  [70] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement, 1),
  [72] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_translation_unit_repeat1, 2),
  [74] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_translation_unit_repeat1, 2), SHIFT_REPEAT(34),
